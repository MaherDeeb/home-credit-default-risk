...
df_bureau = pd.read_csv('df_preapp_decoded.csv')
...
df_train_2.to_csv('df_train_bureau_preapp.csv',index=False) 
...
df_test_2.to_csv('df_test_bureau_preapp.csv',index=False) 
