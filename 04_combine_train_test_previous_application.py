...
df_bureau = pd.read_csv('./data/previous_application.csv')
...
df_train.to_csv('df_train_pa.csv',index=False) 
...
df_test.to_csv('df_test_pa.csv',index=False) 
df_id_submit.to_csv('df_id_pa.csv',index=False)
